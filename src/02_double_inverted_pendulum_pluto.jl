...
# ╔═╡ 7aa74416-c0da-11ee-1e3c-e9e66195df37
begin
...
# ╔═╡ 40726a85-f282-4768-8d73-211cadb8954f
html"""<style>
main {
    max-width: 1400px;
}
...
# ╔═╡ 9b7db81a-5fc6-447e-989e-b33bd8420756
begin
...
# ╔═╡ cba9e2cc-53ee-4506-9de5-0d6dd40cbde0
md"## Set Parameters"

# ╔═╡ 26b64ff4-dc60-47a9-ae9d-bb0007685b97
md"
Mass of first ball:
$(@bind m1 Slider(1.0:0.5:10.0, 1.0, true))

Mass of second ball:
$(@bind m2 Slider(1.0:0.5:10.0, 1.0, true))

Legth of first rod:
$(@bind l1 Slider(1.0:0.5:10.0, 1.0, true))

Legth of second rod:
$(@bind l2 Slider(1.0:0.5:10.0, 1.0, true))

First damping coefficient:
$(@bind c1 Slider(0.1:0.1:1.0, 0.1, true))

Second damping coefficient:
$(@bind c2 Slider(0.1:0.1:1.0, 0.1, true))
"

# ╔═╡ 84b1d729-ba76-4543-8226-535bdf5a2397
md"## Set Initial Condition"

# ╔═╡ 9b6ba0f8-70be-405d-9d31-17ccdc69b343
md"
Angle Position θ₁ of first ball:
$(@bind θ₁ Slider(0.0:0.1:2π, 0.7, true))

Angle Position θ₂ of second ball:
$(@bind θ₂ Slider(0.0:0.1:2π, 0.7, true))

Angular Velocity ω₁ of first ball
$(@bind ω₁ Slider(0:1:20, 0, true))

Angular Velocity ω₂ of first ball
$(@bind ω₂ Slider(0:1:20, 0, true))

End Simulation Time:
$(@bind t_end Slider(10:1:30, 10, true))
"

# ╔═╡ 9906678c-ff83-4da5-a9e2-df2146319d1f
begin
...
sol = solve(prob, alg_hints=[:stiff], dt=0.05)
arr_sol = Array(sol)
...
# ╔═╡ dd0fe4fd-e2b5-4fc9-a2a9-756d99b5a90b
begin
...
@gif for (x1_, y1_, x2_, y2_) in zip(x1, y1, x2, y2)
	
	plot(
		[0.0, x1_], [0.0, y1_], xlim=(-2.0, 2.0), ylim=(-(l1+l2) -1.0, 1.0), linewidth=5.0, xaxis=false, yaxis=false
	)
    plot!(
