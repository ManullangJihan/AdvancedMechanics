...
# ╔═╡ ed2d2dba-c196-11ee-374c-fda64856b9bd
begin
...
# ╔═╡ 6177cfef-a107-4932-aa74-3a4e35c30708
...
# ╔═╡ b59aea88-efa3-4519-94b9-1fda7686c936
md"## Set Initial Parameters
Body mass M1: $(@bind m1 Slider(500:500:5000, 2500, true))\
Suspension mass M2: $(@bind m2 Slider(100:10:500, 320, true))\
Spring constant of suspension system K1: $(@bind k1 Slider(10000:10000:100_000, 80_000, true))\
Spring constant of wheel and tire K2: $(@bind k2 Slider(100_000:100_000:700_000, 500_000, true))\
Damping constant of suspension system b1: $(@bind b1 Slider(100:50:500, 350, true))\
Damping constant of wheel and tire b2: $(@bind b2 Slider(10_000:1000:20_000, 15_000, true))\
"

# ╔═╡ 05bd2e1b-b58c-4968-9cd4-7a6e57b0434c
begin
	# Length of suspension system to Body moss
	l1 = 1.0

	# Length of Wheel and Tire to the suspension
	l2 = 1.0
...
# ╔═╡ f6e4ef0e-4c92-413c-803c-7eefe5c9fc87
md"## Set Initial Condition

Position of body mass x1: $(@bind x1 Slider(x10:1:10, x10+1, true))\
Position of suspension mass x2: $(@bind x2 Slider(l2:1:10, l2+1, true))\

Velocity of body mass v1: $(@bind v1 Slider(0:1:10, 0, true))\
Velocity of suspension mass v1: $(@bind v2 Slider(0:1:10, 0, true))\
"

# ╔═╡ 0b02021c-b539-4715-895d-1cc7751309f8
md"## Set Simulation Parameter
End simulation time $(@bind t_end Slider(10:1:30, 10, true))
"

# ╔═╡ 12fecaf2-5a50-48c7-8f70-3dd161b6139a
begin
...
# ╔═╡ c3b0f8b2-cbb6-4cf1-b539-b5e1b2554b89
begin
	rectangle(x, y, w, h) = Shape(x .+ [0, w, w, 0], y .+ [0, 0, h, h])

	@gif for (x1_, x2_) in zip(x1s, x2s)
		p = plot(
			[W2/2, W2/2], [0.0, x2_], 
			xlims=(0.0, 10.0), ylims=(-10.0, 15.0), legend=false)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "a5c76bec28ae26fd24d478669e6384184313f2b5"
...
git-tree-sha1 = "c25a1ea9a5699895a44a60bf01b341778bcccac5"
