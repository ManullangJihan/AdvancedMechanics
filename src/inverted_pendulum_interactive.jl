...
# ╔═╡ 2b81a710-b50a-11ee-36d7-7397df23e591
begin
...
# ╔═╡ c67d876d-164d-481b-a135-e8178213e5a4
md"""
## Import Libraries
"""

# ╔═╡ 5f133895-1ec0-44da-9be3-0b0683ce7535
md"## Set Parameters"

# ╔═╡ 7bac602e-1338-4773-95ff-1d1dcc70d445
md"## Write the Equation of Motion of the System"

# ╔═╡ 1d7205aa-9f54-4e61-8b98-303ae4c205e8
md"## Simulate the System"

# ╔═╡ 1317eedf-9eac-48fd-8719-2bcf3e21e6b7
md"
Weighting Matrix R\
$(@bind R NumberField(0.0:1.0, 0.001))\
Weight Matrix State Q\
Qx: $(@bind Q1 NumberField(1:100, 1))
Qv: $(@bind Q2 NumberField(1:100, 1))\
Qθ: $(@bind Q3 NumberField(1:100, 1))
Qθ̇: $(@bind Q4 NumberField(1:100, 1))

End Simulation: $(@bind t_end Slider(1:100, 10, true))
"

# ╔═╡ aca97f2d-6033-44f9-bec7-3a73603618ae
begin
	# Params
	m = 1
	M = 5
...
# ╔═╡ 995c78a6-4793-4b89-80fd-9af2d1db274f
begin
	# Simulation
	u(x, t)  = -K * (x .- ref);
...
# ╔═╡ 26f65b04-491f-4b38-a243-6f2277ac571c
begin
...
# ╔═╡ 4754e2f3-22e2-4446-83cf-54e8c698c65e
md"## BODE Plot"

# ╔═╡ 363fe5f9-124b-47ac-b48c-0775caab55ea
md"
Input Delay
$(@bind input_delay Slider(0.0:0.1:1.0, 0.0, true))

Output Delay
$(@bind output_delay Slider(0.0:0.1:1.0, 0.0, true))
"

# ╔═╡ 4b8e4882-ef97-40b9-9cef-4e91761d8bbf
begin
...
# ╔═╡ f045a133-8f6e-4dc7-9999-9a9b3609027b
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "8e9468d2aeadafe79d4d3d26c80c045c30b2e599"
...
git-tree-sha1 = "4ba51af1fd44d0a472ba88418728b9aeb9975cc6"
...
git-tree-sha1 = "11118d08b6ce1886ceb286856a322b24ae94a47b"
...
git-tree-sha1 = "ff3a387c87d2d3c2d7af22c7457e294c450be3db"
