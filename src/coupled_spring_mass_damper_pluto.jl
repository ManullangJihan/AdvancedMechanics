...
# ╔═╡ 0be41ddc-c173-11ee-0fcc-c9a92d1cc309
begin
...
# ╔═╡ 37c80cfa-c865-4642-82db-762b96ad8ab7
md"## Import Libraries"

# ╔═╡ ff3fbb2b-22a7-4830-87ac-d83d69df7749
md"## Define ODE of Coupled Spring mass Damper"

# ╔═╡ 522e320e-4005-4def-9a5e-5b36f1138842
begin
...
# ╔═╡ fced7f76-9c28-460c-9e60-d45635d7351d
md"## Set Parameters"

# ╔═╡ c5f7539f-70e4-474b-9cbc-8097efe63cff
md"
First mass: $(@bind m1 Slider(1:1:10, 5, true))\
Second mass: $(@bind m2 Slider(1:1:10, 2, true))\

First length: $(@bind l1 Slider(1:1:10, 3, true))\
Second length: $(@bind l2 Slider(1:1:10, 2, true))\

First spring constant: $(@bind k1 NumberField(0.0:0.1:10.0, 0.3))\
Second spring constant: $(@bind k2 NumberField(0.0:0.1:10.0, 0.3))

First friction constant: $(@bind c1 NumberField(0.0:0.1:10.0, 0.1))\
Second friction constant: $(@bind c2 NumberField(0.0:0.1:10.0, 0.1))\


"

# ╔═╡ 81dbd626-27c1-44d5-80d9-524947666519
md"## Set Initial Condition"

# ╔═╡ e41e65e2-e54e-4ae2-bfbb-fb380401d40b
md"
x₁0 : $(@bind x₁0 Slider(1:1:10, 1, true))\
x₂0 : $(@bind x₂0 Slider(x₁0+1:1:15, x₁0+l2+1, true))\
v₁0 : $(@bind v₁0 Slider(0:1:10, 0, true))\
v₂0 : $(@bind v₂0 Slider(0:1:10, 0, true))\
"

# ╔═╡ cfc6f8ef-9dc9-45ce-914d-77a69c4ec841
md"## Set Simulation Parameters

End time simulation: $(@bind t_end Slider(10:1:30, 10, true))\
Start Simulation $(@bind start Button(\"Start Simulation\"))
"

# ╔═╡ 672b7df1-b5fa-4c75-b90e-62483cc77f6f
begin
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "178ce9f72d777a06a181c4c4f39316e18a41b0eb"
